                                                ...
                                                <form action="{{url('add/foreign/user/rate')}}" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="number" step="0.01" name="rate" class="form-control border border-left-0" min="1" placeholder="Example: ₦389" value="@if(!is_null($fu_rate)){{$fu_rate->rate}}@endif" style="padding: .6rem .05rem;" required>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <select name="min_amount" class="form-control" required>
                                                                        ...
                                                                        <option value="4500.00">4500</option>
                                                                        <option value="5000.00">5000</option>
                                                                        <option value="5500.00">5500</option>
                                                                        <option value="6000.00">6000</option>
                                                                        <option value="6500.00">6500</option>
                                                                        <option value="7000.00">7000</option>
                                                                        <option value="7500.00">7500</option>
                                                                        <option value="8000.00">8000</option>
                                                                        <option value="8500.00">8500</option>
                                                                        <option value="9000.00">9000</option>
                                                                        <option value="9500.00">9500</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <svg width="384" height="248" viewBox="0 0 384 248" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                        <linearGradient id="paint0_linear" x1="363.718" y1="5.05596e-06" x2="37.8591" y2="251.493" gradientUnits="fu_rateSpaceOnUse">
                        <stop stop-color="#06B6B6"/>
                        <stop offset="1" stop-color="#6594DB"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear" x1="25.4323" y1="87.8877" x2="62.0101" y2="111.582" gradientUnits="fu_rateSpaceOnUse">
