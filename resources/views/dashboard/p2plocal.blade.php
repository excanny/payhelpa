                    ...
                    <div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col text-right">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="javascript:void" class="btn btn-primary px-5 float-right" style="background: #2A8BF2; border: 1px solid #2A8BF2; box-sizing: border-box;border-radius: 30px;"  data-toggle="modal" data-target="#myModal2a" data-backdrop="static">Create your own rate</a>
                                    </div>
                                </div>
                ...
                <div class="row py-5">
                    <div class="col text-center">
                        ...
                        <p class="mt-3" style="font-style: normal; font-weight: 400; font-size: 16px; line-height: 25.57px; text-align: center; color: #979797">Kindly wait for a Helpa to carry out your transaction.</p>
                            ...
                            @else
                                <a class="btn btn-primary px-5 mt-2 text-white" href="{{ url('/dashboard/transaction/'. $lu_rate2->transaction_id. '/details') }}" style="background: #2A8BF2; border: 1px solid #2A8BF2; box-sizing: border-box;border-radius: 30px;">Transaction details</a>
                            @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10">
                        <h4 style="color:#2A8BF2;">Confirmation</h4>
    
                        <p>Transaction will soon be confirmed</p>
                    </div>
            ...
            <div class="modal-body">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col text-right">
                        @if (is_null($lu_rate))
                            <h4 class="text-dark"> <span class="dollar_rate_releasing_lu"></span></h4>
                        @else
                            <h4 class="text-dark"> <span>₦{{number_format($lu_rate->rate)}}</span></h4>
                        @endif
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col text-right">
                        @if (is_null($lu_rate))
                            <h4 class="text-dark"> <span class="amount_releasing_lu"></span></h4>
                        @else
                            <h4 class="text-dark"> <span>${{number_format($lu_rate->max_amount)}}</span></h4>
                        @endif
                ...
                <div class="row mt-2">
                    <div class="col">
                        <h4>Amount (in Naira)</h4>
                    </div>
                    <div class="col text-right">
                        @if (is_null($lu_rate))
                            <h4 class="text-dark"> <span class="value_releasing_lu"></span></h4>
                        @else 
                            <h4 class="text-dark"> <span>₦{{number_format($lu_rate->rate * $lu_rate->max_amount)}}</span></h4>
                        @endif
                ...
                <div class="row mt-5 mb-4">
                    <div class="col text-center">
                        ...
                        <a href="javascript:void" class="btn btn-primary px-5 mx-2 disabled" style="border: 1px solid #2A8BF2; box-sizing: border-box;border-radius: 30px; color: #fff;" >Confirming Transfer....</a>
                    </div>
                </div>
